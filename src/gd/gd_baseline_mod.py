...
class StandardNeuralNet:
    def __init__(self, solver, n_input_units, n_hidden_units_h1, n_hidden_units_h2, n_output_units, lr, tf_seed):
        ...
        self.n_hidden_units_h1  = n_hidden_units_h1
        self.n_hidden_units_h2  = n_hidden_units_h2
    ...
    def _mlp_architecture_binary(self):
        ...
        n_hidden_units_h1  = self.n_hidden_units_h1
        n_hidden_units_h2  = self.n_hidden_units_h2
        ...
        W_fc = binary_tanh_unit(weight_variable([n_in, n_hidden_units_h1]))
        b_fc = binary_tanh_unit(bias_variable([n_hidden_units_h1]))
        ...
        W_fc = binary_tanh_unit(weight_variable([n_hidden_units_h1, n_hidden_units_h2]))
        b_fc = binary_tanh_unit(bias_variable([n_hidden_units_h2]))
        # NOTE: the 0.001 ensures that a zero preactivation is mapped to +1 activation
        x = binary_tanh_unit(tf.matmul(x, W_fc) + b_fc + 0.001) 
        self.weights.append(W_fc)
        self.biases.append(b_fc)
        ...
        W_o = binary_tanh_unit(weight_variable([n_hidden_units_h2, n_output_units]))
    ...
    def _mlp_architecture_ternary(self):
        ...
        W1_fc = binary_tanh_unit(weight_variable([n_in, n_hidden_units_h1]))
        b1_fc = binary_tanh_unit(bias_variable([n_hidden_units_h1]))
        W2_fc = binary_tanh_unit(weight_variable([n_in, n_hidden_units_h1]))
        b2_fc = binary_tanh_unit(bias_variable([n_hidden_units_h1]))
        W_fc = (W1_fc + W2_fc)/2
        b_fc = (b1_fc + b2_fc)/2
        # NOTE: the 0.001 ensures that a zero preactivation is mapped to +1 activation
        x = binary_tanh_unit(tf.matmul(x, W_fc) + b_fc + 0.001)
        ...
        W1_fc = binary_tanh_unit(weight_variable([n_hidden_units_h1, n_hidden_units_h2]))
        b1_fc = binary_tanh_unit(bias_variable([n_hidden_units_h2]))
        W2_fc = binary_tanh_unit(weight_variable([n_hidden_units_h1, n_hidden_units_h2]))
        b2_fc = binary_tanh_unit(bias_variable([n_hidden_units_h2]))
        W_fc = (W1_fc + W2_fc)/2
        b_fc = (b1_fc + b2_fc)/2
        # NOTE: the 0.001 ensures that a zero preactivation is mapped to +1 activation
        x = binary_tanh_unit(tf.matmul(x, W_fc) + b_fc + 0.001)
        ...
        # Fully connected layer 2 (Output layer)
        W1_o = binary_tanh_unit(weight_variable([n_hidden_units_h2, n_output_units]))
        b1_o = binary_tanh_unit(bias_variable([n_output_units]))
        W2_o = binary_tanh_unit(weight_variable([n_hidden_units_h2, n_output_units]))
